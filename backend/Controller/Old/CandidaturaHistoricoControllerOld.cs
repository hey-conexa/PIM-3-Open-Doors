...
namespace OpenDoors.Api.Controller.Old
{
    [ApiController]
    [Route("api/candidaturas-historico")]
    public class CandidaturasHistoricoControllerOld : ControllerBase
    {
        private readonly Supabase.Client _supabase;

        public CandidaturasHistoricoControllerOld(Supabase.Client supabase)
        {
            _supabase = supabase;
        }
